...
const filepath = "d:/skincare/components/features/Navbar.tsx";
const content = fs.readFileSync(filepath, "utf8");
const lines = content.split(/\r?\n/);

const newNav = `                        {/* Unified Shop Megamenu */}
...
const firstPart = lines.slice(0, 60).join('\\n');
const secondPart = lines.slice(265).join('\\n');
const finalContent = firstPart + '\\n' + newNav + '\\n' + secondPart;

fs.writeFileSync(filepath, finalContent, "utf8");
console.log("Navbar successfully updated with Node!");
